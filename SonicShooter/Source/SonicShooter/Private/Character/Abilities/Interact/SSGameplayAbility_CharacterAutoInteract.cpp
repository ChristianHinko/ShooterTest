...
#include "Character\Abilities\Interact\SSGameplayAbility_CharacterAutoInteract.h"
...
bool USSGameplayAbility_CharacterAutoInteract::CanActivateAbility(const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo, const FGameplayTagContainer* SourceTags, const FGameplayTagContainer* TargetTags, OUT FGameplayTagContainer* OptionalRelevantTags) const
{
...
//	if (Interactable->GetIsAutomaticInstantInteract() && Interactable->GetDetectType() == ESSDetectType::DETECTTYPE_Overlapped && ShooterCharacter->CurrentOverlapInteractablesStack.Num() > 0)
//	{
...
//			{
//				if (ShooterCharacter->CurrentOverlapInteractablesStack[i]->GetIsAutomaticInstantInteract() && Interactable->GetDetectType() == ESSDetectType::DETECTTYPE_Overlapped)
//				{
...
//void USSGameplayAbility_CharacterAutoInteract::ActivateAbility(const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo, const FGameplayAbilityActivationInfo ActivationInfo, const FGameplayEventData* TriggerEventData)
//{
//	Super::ActivateAbility(Handle, ActorInfo, ActivationInfo, TriggerEventData);
...
//	}
//
//	DurationInteractCallbacks->OnInteractTickDelegate.AddUObject(this, &USSGameplayAbility_CharacterAutoInteract::OnInteractTick);
//	DurationInteractCallbacks->OnInteractionSweepMissDelegate.AddUObject(this, &USSGameplayAbility_CharacterAutoInteract::OnInteractionSweepMiss);
//	DurationInteractCallbacks->OnSuccessfulInteractDelegate.AddUObject(this, &USSGameplayAbility_CharacterAutoInteract::OnSuccessfullInteract);
//	DurationInteractCallbacks->OnCharacterLeftInteractionOverlapDelegate.AddUObject(this, &USSGameplayAbility_CharacterAutoInteract::OnCharacterLeftInteractionOverlap);
//	DurationInteractCallbacks->OnNewInteractionPriorityDelegate.AddUObject(this, &USSGameplayAbility_CharacterAutoInteract::OnNewInteractionPriority);
...
//void USSGameplayAbility_CharacterAutoInteract::OnInteractTick(float DeltaTime, float TimeHeld)
//{
//	timeHeld = TimeHeld;
//	Interactable->InteractingTick(ShooterCharacter, DeltaTime, TimeHeld);
//}
//
//void USSGameplayAbility_CharacterAutoInteract::OnRelease(float TimeHeld)
//{
//	timeHeld = TimeHeld;
...
//}
//
//void USSGameplayAbility_CharacterAutoInteract::OnInteractionSweepMiss(float TimeHeld)
//{
//	timeHeld = TimeHeld;
...
//
//
//void USSGameplayAbility_CharacterAutoInteract::OnCharacterLeftInteractionOverlap(float TimeHeld)
//{
//	timeHeld = TimeHeld;
...
//}
//
//void USSGameplayAbility_CharacterAutoInteract::OnNewInteractionPriority(float TimeHeld)
//{
//
//
//
...
//
//
//void USSGameplayAbility_CharacterAutoInteract::OnSuccessfullInteract(float TimeHeld)
//{
//	timeHeld = TimeHeld;
...
//void USSGameplayAbility_CharacterAutoInteract::HandleDurationInteractEnded()
//{
...
//	if (bWasCancelled)
//	{
//		InteractEndReason = ESSDurationInteractEndReason::REASON_PredictionCorrected;
...
//	else
//	{
//		if (InteractEndReason == ESSDurationInteractEndReason::REASON_InputRelease)
//		{
//			Interactable->OnDurationInteractEnd(ShooterCharacter, ESSDurationInteractEndReason::REASON_InputRelease, timeHeld);
//		}
//		else if (InteractEndReason == ESSDurationInteractEndReason::REASON_SweepMiss)
//		{
//			Interactable->OnDurationInteractEnd(ShooterCharacter, ESSDurationInteractEndReason::REASON_SweepMiss, timeHeld);
//		}
//		else if (InteractEndReason == ESSDurationInteractEndReason::REASON_CharacterLeftInteractionOverlap)
//		{
//			Interactable->OnDurationInteractEnd(ShooterCharacter, ESSDurationInteractEndReason::REASON_CharacterLeftInteractionOverlap, timeHeld);
//		}
//		else if (InteractEndReason == ESSDurationInteractEndReason::REASON_NewInteractionOverlapPriority)
//		{
//			Interactable->OnDurationInteractEnd(ShooterCharacter, ESSDurationInteractEndReason::REASON_NewInteractionOverlapPriority, timeHeld);
//		}
//		else if (InteractEndReason == ESSDurationInteractEndReason::REASON_SuccessfulInteract)
//		{
//			Interactable->OnDurationInteractEnd(ShooterCharacter, ESSDurationInteractEndReason::REASON_SuccessfulInteract, timeHeld);
//		}
//		else
//		{
//			Interactable->OnDurationInteractEnd(ShooterCharacter, ESSDurationInteractEndReason::REASON_Unknown, timeHeld);
//		}
//	}
//
//	if (Interactable)
...
// From DurationInteract
//void USSGameplayAbility_CharacterAutoInteract::EndAbility(const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo, const FGameplayAbilityActivationInfo ActivationInfo, bool bReplicateEndAbility, bool bWasCancelled)
//{
...
//	if (ScopeLockCount > 0)
//	{
//		WaitingToExecute.Add(FPostLockDelegate::CreateUObject(this, &USSGameplayAbility_CharacterAutoInteract::EndAbility, Handle, ActorInfo, ActivationInfo, bReplicateEndAbility, bWasCancelled));
//		return;
//	}
//
//
