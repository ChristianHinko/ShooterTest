...
#include "STInventoryComponent_Shooter.generated.h"
 ...
 */
UCLASS()
class SHOOTERTEST_API USTInventoryComponent_Shooter : public UAIEInventoryComponent_Active
{
	GENERATED_BODY()
	
public:
	USTInventoryComponent_Shooter(const FObjectInitializer& ObjectInitializer);
