	...
	: Super(ObjectInitializer)
{
	...
	GetCapsuleComponent()->OnComponentBeginOverlap.AddDynamic(this, &AShooterCharacter::OnComponentBeginOverlapCharacterCapsule);
	GetCapsuleComponent()->OnComponentEndOverlap.AddDynamic(this, &AShooterCharacter::OnComponentEndOverlapCharacterCapsule);
}
...
IInteractable* AShooterCharacter::ScanForCurrentPrioritizedInteractable(FHitResult& OutHit)
{
...
void AShooterCharacter::OnComponentBeginOverlapCharacterCapsule(UPrimitiveComponent* OverlappedComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
...
void AShooterCharacter::OnComponentEndOverlapCharacterCapsule(UPrimitiveComponent* OverlappedComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex)
{
	if (IInteractable* Interactable = Cast<IInteractable>(OtherActor))
	{
		if (CurrentOverlapInteractablesStack.Num() > 0)
