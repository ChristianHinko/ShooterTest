...
#include "STGameplayEffectExecutionCalculation_InitGun.generated.h"
 ...
 */
UCLASS()
class SHOOTERTEST_API USTGameplayEffectExecutionCalculation_InitGun : public UGameplayEffectExecutionCalculation
{
	GENERATED_BODY()

public:
	USTGameplayEffectExecutionCalculation_InitGun(const FObjectInitializer& ObjectInitializer);
