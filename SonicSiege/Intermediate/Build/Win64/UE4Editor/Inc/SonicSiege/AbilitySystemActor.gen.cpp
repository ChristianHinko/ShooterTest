...
// End Cross Module References
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_ActorAbilitySpecHandle_MetaData[];
#endif
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_ActorAbilitySpecHandle;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_ActorAbilityTSub_MetaData[];
#endif
		static const UE4CodeGen_Private::FClassPropertyParams NewProp_ActorAbilityTSub;
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AAbilitySystemActor_Statics::NewProp_ActorAbilitySystemComponent = { "ActorAbilitySystemComponent", nullptr, (EPropertyFlags)0x0040000000080008, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AAbilitySystemActor, ActorAbilitySystemComponent), Z_Construct_UClass_USSAbilitySystemComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AAbilitySystemActor_Statics::NewProp_ActorAbilitySystemComponent_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AAbilitySystemActor_Statics::NewProp_ActorAbilitySystemComponent_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AAbilitySystemActor_Statics::NewProp_ActorAbilitySpecHandle_MetaData[] = {
		{ "ModuleRelativePath", "Public/Actor/AbilitySystemActor.h" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_AAbilitySystemActor_Statics::NewProp_ActorAbilitySpecHandle = { "ActorAbilitySpecHandle", nullptr, (EPropertyFlags)0x0020080000000020, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AAbilitySystemActor, ActorAbilitySpecHandle), Z_Construct_UScriptStruct_FGameplayAbilitySpecHandle, METADATA_PARAMS(Z_Construct_UClass_AAbilitySystemActor_Statics::NewProp_ActorAbilitySpecHandle_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AAbilitySystemActor_Statics::NewProp_ActorAbilitySpecHandle_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AAbilitySystemActor_Statics::NewProp_ActorAbilityTSub_MetaData[] = {
		{ "Category", "AbilitySystemSetup|Abilities" },
		{ "Comment", "//\x09--Test Abilities--\n" },
		{ "ModuleRelativePath", "Public/Actor/AbilitySystemActor.h" },
		{ "ToolTip", "--Test Abilities--" },
	};
#endif
	const UE4CodeGen_Private::FClassPropertyParams Z_Construct_UClass_AAbilitySystemActor_Statics::NewProp_ActorAbilityTSub = { "ActorAbilityTSub", nullptr, (EPropertyFlags)0x0024080000000001, UE4CodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AAbilitySystemActor, ActorAbilityTSub), Z_Construct_UClass_USSGameplayAbility_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UClass_AAbilitySystemActor_Statics::NewProp_ActorAbilityTSub_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AAbilitySystemActor_Statics::NewProp_ActorAbilityTSub_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AAbilitySystemActor_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AAbilitySystemActor_Statics::NewProp_ActorAbilitySpecHandle,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AAbilitySystemActor_Statics::NewProp_ActorAbilityTSub,
	};
	...
	IMPLEMENT_CLASS(AAbilitySystemActor, 3117124714);
	...
	{
		static const FName Name_ActorAbilitySpecHandle(TEXT("ActorAbilitySpecHandle"));
		static const FName Name_ActorAttributeSet(TEXT("ActorAttributeSet"));

		const bool bIsValid = true
			&& Name_ActorAbilitySpecHandle == ClassReps[(int32)ENetFields_Private::ActorAbilitySpecHandle].Property->GetFName()
