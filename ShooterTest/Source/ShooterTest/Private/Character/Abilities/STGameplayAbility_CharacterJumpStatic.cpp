...
USTGameplayAbility_CharacterJumpStatic::USTGameplayAbility_CharacterJumpStatic(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
	...
	AbilityTags.AddTag(STNativeGameplayTags::Ability_Movement_JumpStatic);
...
void USTGameplayAbility_CharacterJumpStatic::ActivateAbility(const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo, const FGameplayAbilityActivationInfo ActivationInfo, const FGameplayEventData* TriggerEventData)
{
	...
	if (!Character)
	{
		UE_LOG(LogSTGameplayAbility, Warning, TEXT("%s() Character was NULL when trying to activate static jump ability. Called EndAbility()"), ANSI_TO_TCHAR(__FUNCTION__));
...
void USTGameplayAbility_CharacterJumpStatic::InputReleased(const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo, const FGameplayAbilityActivationInfo ActivationInfo)
{
