...
public:	
	...
	UFUNCTION(BlueprintCallable, Category = "FPSTemplate | Firearm")
	AFPSTemplateFirearm* AddFirearm(TSubclassOf<AFPSTemplateFirearm> FirearmClass, bool SetAsCurrent = false, bool SetHidden = false);
	UFUNCTION(BlueprintCallable, Category = "FPSTemplate | Firearm")
	void AddExistingFirearm(AFPSTemplateFirearm* Firearm);
	UFUNCTION(BlueprintCallable, Category = "FPSTemplate | Firearm")
	...
	UFUNCTION(BlueprintCallable, Category = "FPSTemplate | Firearm")
	AFPSTemplateFirearm* SwitchToFirearm(AFPSTemplateFirearm* Firearm, const FName CurrentFirearmAttachSocket = NAME_None, bool HideCurrentFirearm = true);
	UFUNCTION(BlueprintCallable, Category = "FPSTemplate | Firearm")
