...
#include "SSActorComponent_Interactable.generated.h"


UCLASS( ClassGroup=(Custom), meta=(BlueprintSpawnableComponent) )
class SONICSHOOTER_API USSActorComponent_Interactable : public UActorComponent, public ISSInteractableInterface
{
	GENERATED_BODY()

public:	
	// Sets default values for this component's properties
	USSActorComponent_Interactable();


	// BEGIN ISSInteractableInterface interface
	...
	virtual void OnInstantInteract(ASSCharacter_Shooter* InteractingCharacter) override;

	virtual void OnDurationInteractBegin(ASSCharacter_Shooter* InteractingCharacter) override;
	virtual void InteractingTick(ASSCharacter_Shooter* InteractingCharacter, float DeltaTime, float CurrentInteractionTime) override;
	virtual void OnDurationInteractEnd(ASSCharacter_Shooter* InteractingCharacter, ESSDurationInteractEndReason DurationInteractEndReason, float InteractionTime) override;

	virtual void OnInitialDetect(ASSCharacter_Shooter* InteractingCharacter) override;
	virtual void OnConsecutiveDetect(ASSCharacter_Shooter* InteractingCharacter) override;
	virtual void OnEndDetect(ASSCharacter_Shooter* InteractingCharacter) override;
	...
	// END ISSInteractableInterface interface
