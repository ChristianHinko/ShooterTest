...
#include "SSObject_Stamina.generated.h"
 ...
 */
UCLASS()
class SONICSHOOTER_API USSObject_Stamina : public UObject, public FTickableGameObject
{
	GENERATED_BODY()
...
public:
	USSObject_Stamina(const FObjectInitializer& ObjectInitializer);
