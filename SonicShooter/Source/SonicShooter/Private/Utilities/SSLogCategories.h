...
DECLARE_LOG_CATEGORY_EXTERN(LogGameplayAbilityTask, Log, All)
...
DECLARE_LOG_CATEGORY_EXTERN(LogPlayerControllerSetup, Log, All)
DECLARE_LOG_CATEGORY_EXTERN(LogCharacterSetup, Log, All)
...
DECLARE_LOG_CATEGORY_EXTERN(LogBulletTrace, Log, All)
