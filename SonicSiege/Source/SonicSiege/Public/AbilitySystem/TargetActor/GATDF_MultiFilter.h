...
struct SONICSIEGE_API FGATDF_MultiFilter/* : public FGameplayTargetDataFilter*/
{
 ...
 */
USTRUCT(BlueprintType)
struct SONICSIEGE_API FGATDF_MultiFilterHandle/* : public FGameplayTargetDataFilterHandle*/
{
	GENERATED_USTRUCT_BODY()
