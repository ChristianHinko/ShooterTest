...
#include "SSGameplayAbility_CharacterAutoInteract.generated.h"
 ...
 */
UCLASS()
class SONICSHOOTER_API USSGameplayAbility_CharacterAutoInteract : public UASSGameplayAbility
{
	GENERATED_BODY()

public:
	USSGameplayAbility_CharacterAutoInteract(const FObjectInitializer& ObjectInitializer);
