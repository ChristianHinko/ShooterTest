...
class FBXElem:
    ...
    def add_bool(self, data):
        ...
        self.props_type.append(bbdata_types.BOOL)
    ...
    def add_int16(self, data):
        ...
        self.props_type.append(bbdata_types.INT16)
        self.props.append(data)
    ...
    def add_int32(self, data):
        ...
        self.props_type.append(bbdata_types.INT32)
        self.props.append(data)
    ...
    def add_int64(self, data):
        ...
        self.props_type.append(bbdata_types.INT64)
        self.props.append(data)
    ...
    def add_float32(self, data):
        ...
        self.props_type.append(bbdata_types.FLOAT32)
        self.props.append(data)
    ...
    def add_float64(self, data):
        ...
        self.props_type.append(bbdata_types.FLOAT64)
        self.props.append(data)
    ...
    def add_bytes(self, data):
        ...
        self.props_type.append(bbdata_types.BYTES)
        self.props.append(data)
    ...
    def add_string(self, data):
        ...
        self.props_type.append(bbdata_types.STRING)
        self.props.append(data)
    ...
    def add_int32_array(self, data):
        if not isinstance(data, array.array):
            data = array.array(bbdata_types.ARRAY_INT32, data)
        self._add_array_helper(data, bbdata_types.ARRAY_INT32, bbdata_types.INT32_ARRAY)

    def add_int64_array(self, data):
        if not isinstance(data, array.array):
            data = array.array(bbdata_types.ARRAY_INT64, data)
        self._add_array_helper(data, bbdata_types.ARRAY_INT64, bbdata_types.INT64_ARRAY)

    def add_float32_array(self, data):
        if not isinstance(data, array.array):
            data = array.array(bbdata_types.ARRAY_FLOAT32, data)
        self._add_array_helper(data, bbdata_types.ARRAY_FLOAT32, bbdata_types.FLOAT32_ARRAY)

    def add_float64_array(self, data):
        if not isinstance(data, array.array):
            data = array.array(bbdata_types.ARRAY_FLOAT64, data)
        self._add_array_helper(data, bbdata_types.ARRAY_FLOAT64, bbdata_types.FLOAT64_ARRAY)

    def add_bool_array(self, data):
        if not isinstance(data, array.array):
            data = array.array(bbdata_types.ARRAY_BOOL, data)
        self._add_array_helper(data, bbdata_types.ARRAY_BOOL, bbdata_types.BOOL_ARRAY)

    def add_byte_array(self, data):
        if not isinstance(data, array.array):
            data = array.array(bbdata_types.ARRAY_BYTE, data)
        self._add_array_helper(data, bbdata_types.ARRAY_BYTE, bbdata_types.BYTE_ARRAY)
