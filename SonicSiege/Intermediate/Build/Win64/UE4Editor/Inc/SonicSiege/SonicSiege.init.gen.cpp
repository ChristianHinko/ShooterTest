	...
	UPackage* Z_Construct_UPackage__Script_SonicSiege()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_SonicSiege_RepeatActionDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SonicSiege_TickDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SonicSiege_DurationEnded__DelegateSignature,
