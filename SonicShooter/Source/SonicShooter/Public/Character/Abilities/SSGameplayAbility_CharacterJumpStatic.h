...
#include "SSGameplayAbility_CharacterJumpStatic.generated.h"
 ...
 */
UCLASS()
class SONICSHOOTER_API USSGameplayAbility_CharacterJumpStatic : public UASSGameplayAbility
{
	GENERATED_BODY()

public:
	USSGameplayAbility_CharacterJumpStatic(const FObjectInitializer& ObjectInitializer);
