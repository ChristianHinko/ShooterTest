...
void AItem::OnInstantInteract(AShooterCharacter* InteractingPawn)
{
...
void AItem::OnDurationInteractBegin(AShooterCharacter* InteractingPawn)
{
	UKismetSystemLibrary::PrintString(this, "OnDurationInteractBegin", true, false, FLinearColor::Gray);
}
void AItem::InteractingTick(AShooterCharacter* InteractingPawn, float DeltaTime, float CurrentInteractionTime)
{
...
void AItem::OnDurationInteractEnd(AShooterCharacter* InteractingPawn, EDurationInteractEndReason DurationInteractEndReason, float InteractionTime)
{
	ENetRole role = GetLocalRole();
