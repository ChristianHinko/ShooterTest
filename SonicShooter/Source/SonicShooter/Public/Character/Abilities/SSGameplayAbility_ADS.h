...
#include "SSGameplayAbility_ADS.generated.h"

/**
 * 
 */
UCLASS()
class SONICSHOOTER_API USSGameplayAbility_ADS : public UASSGameplayAbility
{
	GENERATED_BODY()
	
public:
	USSGameplayAbility_ADS(const FObjectInitializer& ObjectInitializer);
