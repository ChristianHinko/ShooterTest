...
#include "SSCharacter_PushModelDemo.generated.h"
 ...
 */
UCLASS()
class SONICSHOOTER_API ASSCharacter_PushModelDemo : public ASSCharacter
{
	GENERATED_BODY()

public:
	ASSCharacter_PushModelDemo(const FObjectInitializer& ObjectInitializer);
