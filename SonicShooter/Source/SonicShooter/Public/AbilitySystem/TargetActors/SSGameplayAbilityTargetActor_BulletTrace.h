...
#include "SSGameplayAbilityTargetActor_BulletTrace.generated.h"
 ...
 */
UCLASS()
class SONICSHOOTER_API ASSGameplayAbilityTargetActor_BulletTrace : public AASSGameplayAbilityTargetActor
{
	GENERATED_BODY()
