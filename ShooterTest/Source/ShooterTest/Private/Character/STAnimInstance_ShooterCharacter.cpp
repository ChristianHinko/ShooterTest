...
USTAnimInstance_ShooterCharacter::USTAnimInstance_ShooterCharacter(const FObjectInitializer& ObjectInitializer)
...
void USTAnimInstance_ShooterCharacter::NativeInitializeAnimation()
{
	Super::NativeInitializeAnimation();


	OwningShooterCharacter = Cast<ASTCharacter_Shooter>(GetOwningActor());
}
void USTAnimInstance_ShooterCharacter::NativeUpdateAnimation(float DeltaTimeX)
{
...
bool USTAnimInstance_ShooterCharacter::IsTurnInPlaceEnabled() const
{
...
bool USTAnimInstance_ShooterCharacter::IsTurnInPlaceAvailable() const
{
...
void USTAnimInstance_ShooterCharacter::TurnInPlace(float DeltaTimeX)
{
...
FRotator USTAnimInstance_ShooterCharacter::GetHeadLookAtTargetRot(AActor* Target, float deltaTime)
{
	...
	if (OwningShooterCharacter.IsValid() && Target)
	{
		...
		if (ASTCharacter_Shooter* ShooterCharacterToLookAt = Cast<ASTCharacter_Shooter>(Target))
		{
...
APawn* USTAnimInstance_ShooterCharacter::GetNearestPawn(const AActor* InActor)
{
