...
USSAnimInstance_ShooterCharacter::USSAnimInstance_ShooterCharacter(const FObjectInitializer& ObjectInitializer)
...
void USSAnimInstance_ShooterCharacter::NativeInitializeAnimation()
{
	Super::NativeInitializeAnimation();


	OwningShooterCharacter = Cast<ASSCharacter_Shooter>(GetOwningActor());
}
void USSAnimInstance_ShooterCharacter::NativeUpdateAnimation(float DeltaTimeX)
{
	Super::NativeUpdateAnimation(DeltaTimeX);


	if (const ASSCharacter_Shooter* ShooterCharacter = OwningShooterCharacter.Get())
	{
...
bool USSAnimInstance_ShooterCharacter::IsTurnInPlaceEnabled() const
{
...
bool USSAnimInstance_ShooterCharacter::IsTurnInPlaceAvailable() const
{
...
void USSAnimInstance_ShooterCharacter::TurnInPlace(float DeltaTimeX)
{
...
FRotator USSAnimInstance_ShooterCharacter::GetHeadLookAtTargetRot(AActor* Target, float deltaTime)
{
	...
	if (OwningShooterCharacter.IsValid() && Target)
	{
		...
		if (ASSCharacter_Shooter* ShooterCharacterToLookAt = Cast<ASSCharacter_Shooter>(Target))
		{
...
APawn* USSAnimInstance_ShooterCharacter::GetNearestPawn(const AActor* InActor)
{
