...
#include "GEEC_GunInitialization.generated.h"
 ...
 */
UCLASS()
class SONICSHOOTER_API UGEEC_GunInitialization : public UGameplayEffectExecutionCalculation
{
	GENERATED_BODY()

public:
	UGEEC_GunInitialization();
