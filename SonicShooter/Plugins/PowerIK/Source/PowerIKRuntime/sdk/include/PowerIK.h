...
// NOTE!! Uncomment this if you are building from the source code SDK.
// this will export all the Power IK symbols for linking.
// #define POWERIK_EXPORTS

/**
 * This symbol should NOT be defined on any project that uses PowerIK
 * This way any project whose source files include this file see
 * POWERIK_LIB_API functions as being imported from a DLL.
 */
#ifdef POWERIK_EXPORTS
	 // this block is for building from source 
	#ifdef _WIN32
	...
	#endif
#else
	// this block is for using a binary / .dll
	#ifdef _WIN32
		#define POWERIK_LIB_API __declspec(dllimport)
	#endif
	#ifdef __linux__
		#define POWERIK_LIB_API
	#endif
#endif
