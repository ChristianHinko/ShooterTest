...
public:
	...
	ATTRIBUTE_ACCESSORS(USTAttributeSet_Gun, MinBulletSpread)
	...
	ATTRIBUTE_ACCESSORS(USTAttributeSet_Gun, MovingBulletSpread)
	...
	ATTRIBUTE_ACCESSORS(USTAttributeSet_Gun, BulletSpreadIncRate)
	...
	ATTRIBUTE_ACCESSORS(USTAttributeSet_Gun, FireBulletSpread)
	...
	ATTRIBUTE_ACCESSORS(USTAttributeSet_Gun, NumberOfBulletsPerFire)
	...
	ATTRIBUTE_ACCESSORS(USTAttributeSet_Gun, MaxRange)
	...
	ATTRIBUTE_ACCESSORS(USTAttributeSet_Gun, Penetrations)
	...
	ATTRIBUTE_ACCESSORS(USTAttributeSet_Gun, Ricochets)
	...
	ATTRIBUTE_ACCESSORS(USTAttributeSet_Gun, InitialBulletSpeed)
	...
	ATTRIBUTE_ACCESSORS(USTAttributeSet_Gun, BulletSpeedFalloff)
	...
	ATTRIBUTE_ACCESSORS(USTAttributeSet_Gun, bFullAuto)
	...
	ATTRIBUTE_ACCESSORS(USTAttributeSet_Gun, TimeBetweenShots)
	...
	ATTRIBUTE_ACCESSORS(USTAttributeSet_Gun, TimeBetweenFiresOverride)
	...
	ATTRIBUTE_ACCESSORS(USTAttributeSet_Gun, TimeBetweenBurstsOverride)
	...
	ATTRIBUTE_ACCESSORS(USTAttributeSet_Gun, NumShotsPerBurst)
	...
	ATTRIBUTE_ACCESSORS(USTAttributeSet_Gun, AmmoCost)
