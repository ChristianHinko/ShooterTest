...
#include "Character/Abilities/SSGameplayAbility_CharacterJumpStatic.h"
	...
	: Super(ObjectInitializer)
{
	...
	AbilityTags.AddTag(SSNativeGameplayTags::Ability_Movement_JumpStatic);
}


bool USSGameplayAbility_CharacterJumpStatic::CanActivateAbility(const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo, const FGameplayTagContainer* SourceTags, const FGameplayTagContainer* TargetTags, OUT FGameplayTagContainer* OptionalRelevantTags) const
{
...
void USSGameplayAbility_CharacterJumpStatic::ActivateAbility(const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo, const FGameplayAbilityActivationInfo ActivationInfo, const FGameplayEventData* TriggerEventData)
{
...
void USSGameplayAbility_CharacterJumpStatic::InputReleased(const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo, const FGameplayAbilityActivationInfo ActivationInfo)
{
