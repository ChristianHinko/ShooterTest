...
#include "SSGameplayAbility_CharacterJump.generated.h"
 ...
 */
UCLASS()
class SONICSHOOTER_API USSGameplayAbility_CharacterJump : public UASSGameplayAbility
{
	GENERATED_BODY()

public:
	USSGameplayAbility_CharacterJump(const FObjectInitializer& ObjectInitializer);
