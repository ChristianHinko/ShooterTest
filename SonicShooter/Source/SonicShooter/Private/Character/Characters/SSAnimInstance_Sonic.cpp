...
#include "Character/Characters/SSAnimInstance_Sonic.h"
...
USSAnimInstance_Sonic::USSAnimInstance_Sonic(const FObjectInitializer& ObjectInitializer)
...
void USSAnimInstance_Sonic::NativeInitializeAnimation()
{
...
void USSAnimInstance_Sonic::NativeUpdateAnimation(float DeltaTimeX)
{
...
FRotator USSAnimInstance_Sonic::Look(FName boneName, AActor* lookTarget, float deltaTime)
{
	...
	if (ASSCharacter_Shooter* ShooterCharacterToLookAt = Cast<ASSCharacter_Shooter>(lookTarget))
	{
