...
#include "SSObject_BulletSpread.generated.h"
 ...
 */
UCLASS()
class SONICSHOOTER_API USSObject_BulletSpread : public UObject, public FTickableGameObject
{
	GENERATED_BODY()
...
public:
	USSObject_BulletSpread(const FObjectInitializer& ObjectInitializer);
