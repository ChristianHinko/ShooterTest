...
UENUM()
enum class ESTDurationInteractEndReason
{
...
class USTInteractableInterface : public UInterface
{
    GENERATED_BODY()
};
 ...
 */
class SHOOTERTEST_API ISTInteractableInterface
{
    GENERATED_BODY()

public:
    ISTInteractableInterface();
    ...
    void InjectDetectType(ESTDetectType newDetectType);
    /** WARNING: Implementors don't touch! External use only! */
...
#pragma region InstantInteraction
    ...
    virtual void OnInstantInteract(ASTCharacter_Shooter* InteractingCharacter);
#pragma endregion
...
#pragma region DurationInteraction
    ...
    virtual void OnDurationInteractBegin(ASTCharacter_Shooter* InteractingCharacter);
    // Called every frame during a duration interaction (while interact input is down)
    virtual void InteractingTick(ASTCharacter_Shooter* InteractingCharacter, float DeltaTime, float CurrentInteractionTime);
    // Called anytime a duration interaction ends (whatever the reason may be)
    virtual void OnDurationInteractEnd(ASTCharacter_Shooter* InteractingCharacter, ESTDurationInteractEndReason DurationInteractEndReason, float InteractionTime);
#pragma endregion
...
#pragma region Detection Events
    ...
    virtual void OnInitialDetect(ASTCharacter_Shooter* InteractingCharacter);
    // This remains the player's current interactable
    virtual void OnConsecutiveDetect(ASTCharacter_Shooter* InteractingCharacter);
    // This is no longer the player's current interactable
    virtual void OnEndDetect(ASTCharacter_Shooter* InteractingCharacter);
#pragma endregion
