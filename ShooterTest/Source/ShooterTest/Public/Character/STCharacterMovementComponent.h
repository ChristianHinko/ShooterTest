...
class USTAttributeSet_CharacterMovement;
 ...
 */
UENUM()
enum class ESTCustomMovementMode : uint8
{
 ...
 */
UCLASS()
class SHOOTERTEST_API USTCharacterMovementComponent : public UCharacterMovementComponent
{
    GENERATED_BODY()

    friend class FSTSavedMove_Character;
public:
    USTCharacterMovementComponent(const FObjectInitializer& ObjectInitializer);
...
protected:
    ...
    UPROPERTY()
        TWeakObjectPtr<ASTCharacter> STCharacterOwner;
    UPROPERTY()
        TWeakObjectPtr<UAbilitySystemComponent> OwnerASC;
    UPROPERTY()
        TWeakObjectPtr<USTAttributeSet_CharacterMovement> CharacterMovementAttributeSet;

    virtual void OnInitializeAbilitySystemComponent(UAbilitySystemComponent& ASC);
...
class FSTSavedMove_Character : public FSavedMove_Character
{
...
class FSTNetworkPredictionData_Client_Character : public FNetworkPredictionData_Client_Character
{
    typedef FNetworkPredictionData_Client_Character Super;
public:
    FSTNetworkPredictionData_Client_Character(const UCharacterMovementComponent& ClientMovement);
