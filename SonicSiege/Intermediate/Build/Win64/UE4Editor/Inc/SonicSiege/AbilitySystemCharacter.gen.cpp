...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AAbilitySystemCharacter_Statics::NewProp_FireAbilitySpecHandle_MetaData[] = {
		{ "ModuleRelativePath", "Public/Character/AbilitySystemCharacter.h" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_AAbilitySystemCharacter_Statics::NewProp_FireAbilitySpecHandle = { "FireAbilitySpecHandle", nullptr, (EPropertyFlags)0x0020080000000020, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AAbilitySystemCharacter, FireAbilitySpecHandle), Z_Construct_UScriptStruct_FGameplayAbilitySpecHandle, METADATA_PARAMS(Z_Construct_UClass_AAbilitySystemCharacter_Statics::NewProp_FireAbilitySpecHandle_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AAbilitySystemCharacter_Statics::NewProp_FireAbilitySpecHandle_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AAbilitySystemCharacter_Statics::NewProp_FireAbilityTSub_MetaData[] = {
		{ "Category", "AbilitySystemSetup|Abilities" },
		{ "ModuleRelativePath", "Public/Character/AbilitySystemCharacter.h" },
	};
#endif
	const UE4CodeGen_Private::FClassPropertyParams Z_Construct_UClass_AAbilitySystemCharacter_Statics::NewProp_FireAbilityTSub = { "FireAbilityTSub", nullptr, (EPropertyFlags)0x0024080000000001, UE4CodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AAbilitySystemCharacter, FireAbilityTSub), Z_Construct_UClass_USSGameplayAbility_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UClass_AAbilitySystemCharacter_Statics::NewProp_FireAbilityTSub_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AAbilitySystemCharacter_Statics::NewProp_FireAbilityTSub_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AAbilitySystemCharacter_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AAbilitySystemCharacter_Statics::NewProp_FireAbilitySpecHandle,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AAbilitySystemCharacter_Statics::NewProp_FireAbilityTSub,
	...
	IMPLEMENT_CLASS(AAbilitySystemCharacter, 1697236025);
