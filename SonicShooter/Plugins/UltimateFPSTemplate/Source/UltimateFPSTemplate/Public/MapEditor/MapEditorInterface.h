...
#include "MapEditorDataTypes.h" // =@MODIFIED MARKER@= this fixes line 34 ``void OnMaterialLoaded(FMapEditorItemMaterial MapEditorItemMaterial);`` firearm needs to fix this
